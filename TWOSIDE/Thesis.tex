\documentclass[12pt,a4paper,twoside]{report} % Document class and options
...
% Abbreviations
\input{AbbreviationsSymbols/Abbreviations}
% Call method\ac{usa}
% Symbols
\input{AbbreviationsSymbols/Symbols}
% Call method $\gls{F}$
% Date format
...
\includeonly{
    ...
    mainmatter/C7, % Chapter 1
    mainmatter/C8, % Chapter 2
    mainmatter/C9, % Chapter 3
    mainmatter/C10, % Chapter 4
    mainmatter/C11, % Chapter 5
    mainmatter/C12,% CHAPT3ER12
...
\newgeometry{twoside=false, left=35mm, right=25mm, top=25mm, bottom=25mm}% Switch to oneside layout with new geometry 
...
\restoregeometry % Restore the original twoside layout
%----------Forms-----------------------
...
\include{mainmatter/C7}% Chapter 1
\include{mainmatter/C8}% Chapter 2
\include{mainmatter/C9} % Chapter 3
\include{mainmatter/C10} % Chapter 4
\include{mainmatter/C11}% Chapter 5
\include{mainmatter/C12}% CHAPT3ER12
% Back matter
